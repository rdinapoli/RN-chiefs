...
**Recorded**: ~75 years after slave raids
...
**Assessment**: The matatoa system described by Roussel is the aspect of post-raid political organization most consistent with what Eyraud independently observed. This suggests that matatoa-style personal dominance was the functioning political reality, while ariki authority was a memory or narrative.
...
Métraux (1934/1937) adds a further step in this trajectory but with a distinctive contribution. Working 72 years post-raids with a trained Polynesian ethnographer's comparative framework, Métraux describes MORE chiefly prerogatives than Routledge (first-fruits, harvest tapus, servant classes, tuna distribution, fertility chant) yet reaches the SAME conclusion about no political power. He had access to Roussel's recently published 1926 Annales text, which Routledge did not. His conclusion, based on both fieldwork and textual analysis, is that Roussel's claim of ancient absolute power is "an entirely gratuitous assumption" (p. 58). The convergence between Routledge and Métraux on limited power is partly attributable to their shared reliance on Tepano, but Métraux's independent access to Roussel's texts and additional informants (Victoria Rapahango) provide partial independence.
