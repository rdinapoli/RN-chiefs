...
| `ethnographic_sources_evidence.md` | **populated (7 post-raid sources)** | ~400 | Eyraud 1864, Roussel 1869, Loti 1872, Pinart 1877, Geiseler 1883, Thompson 1891, Routledge 1919 |
...
- **Processing order for remaining post-raid sources**: (1) Metraux 1940 (in repo); (2) Englert (need to acquire).
